...
function example_style_settings() {
  ...
  $form['responsive_menus_simple_text'] = array(
    '#type' => 'textfield',
    '#title' => t('Text to display for menu toggle open button'),
    '#default_value' => variable_get('responsive_menus_simple_text', '☰ Menu'),
  );
  $form['responsive_menus_close_text'] = array(
    '#type' => 'textfield',
    '#title' => t('Text to display for menu toggle close button'),
    '#default_value' => variable_get('responsive_menus_close_text', 'X Close'),
  );
...
function example_style_js_settings() {
  ...
  $js_settings['toggler_close'] = variable_get('responsive_menus_close_text', 'X Close');
